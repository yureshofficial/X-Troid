...
//swtich case
    ...
    {buttonId: ` ping `, buttonText: {displayText: 'SCRIPT'}, type: 1},
    {buttonId: ` ping `, buttonText: {displayText: 'LIST MENU'}, type: 1}
    ]
    let buttonMessage = {
    image: { url: `https://i.ibb.co/LJgWsZd/c29af1677d40.jpg` },
    caption: `
*🤖Runtime: ${runtime(process.uptime())}*

   
*® ᴄʏʙᴇʀ ɴᴇᴛᴡᴏʀᴋ ᴜꜱᴇʀ ꜱᴘᴀᴍ ʙᴏᴛᴢ*`,
